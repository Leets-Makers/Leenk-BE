...
public record LeenkUpdateRequest(
        ...
        @Schema(description = "수정할 최대 참여 인원", example = "20")
        @Min(value = 3, message = "모집 인원은 최소 3명이어야 합니다")
        @Max(value = 99, message = "모집 인원은 최대 99명까지 가능 합니다")
        Long maxParticipants,

        @Schema(description = "수정할 이미지", example = "https://s3.example.com/img1.jpg", nullable = true)
        String mediaUrl
) {
}
