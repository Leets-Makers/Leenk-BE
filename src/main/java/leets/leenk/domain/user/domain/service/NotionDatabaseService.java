...
public class NotionDatabaseService {
    ...
    @Value("${notion.report_database_leenk_id}")
    private String REPORT_DATABASE_LEENK_ID;
    ...
    @Async
    public void sendLeenkReport(String report, Long userId, Long leenkId) {
        String today = LocalDate.now().toString();

        Map<String, Object> requestBody = Map.of(
                "parent", Map.of(
                        "type", "database_id",
                        "database_id", REPORT_DATABASE_LEENK_ID
                ),
                "properties", Map.of(
                        "사유", Map.of(
                                "title", List.of(
                        ...
                        "링크 id", Map.of(
                                "rich_text", List.of(
                                        Map.of("text", Map.of("content", String.valueOf(leenkId)))
                                )
                        ),
                        "사용자 id", Map.of(
                                "rich_text", List.of(
